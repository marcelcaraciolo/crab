...
This module contains functions and classes to compute the new score for a preference given an thing (user or item).
...
class TanHScorer(Scorer):
	'''
	A simple Scorer which returns the score normalized betweeen 0 and 1 where 1 is most similar and 0 dissimilar.
	'''
